...
<div class="container" id="noticias">
    <div class="row">
        <div class="col-sm-9">
            <div id="titulos_menor">TODOS OS ARQUIVOS</div>
            ...
            <table id="tabela" class="display table table-striped table-hover" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php
                    $pagManuais = new Read;
                    $pagManuais->ExeRead("noticia,midia", "WHERE  Area_cd_area = 756 and cd_noticia = cd_not and tp_midia = 'Texto' ORDER BY cd_noticia DESC");
