...
<div class="container" id="carousel">
    <div class="row">
        ...
        <div class="col-sm-6" id="noticias">
            ...
            <?php
            //            $getNoticias = DBRead('noticia, midia', "where Area_cd_area = 732 and cd_noticia = cd_not and tp_midia = 'Imagem' order by cd_noticia desc limit 3", 'cd_not, arquivo, nm_noticia, texto');
            foreach ($getNoticias as $Noticias) {
                ...
                <a href="index.php?exe=pagina&id=<?php echo strip_tags($Noticias['cd_not']); ?>">
                    <div class="row espaco nota">
                        ...
                        <div class="col-sm-5">
                            <div style="background-image: url(https://editor.amapa.gov.br/editor/Arquivos/Imagens/noticia<?php echo strip_tags($Noticias['cd_not']); ?>/pequena/<?php echo strip_tags($Noticias['arquivo']); ?>);width:150px;height:100px;" class="fakeImg"></div>
                        </div>
            ...
            <a href="index.php?exe=noticia_lista" class="btn btn-primary btn-xs">+ ler todas</a>
        </div>
        <!--FIM DAS NOTÍCIAS ##############################################################################-->
