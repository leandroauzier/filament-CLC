...
<html lang="pt_br">
    ...
    <body>
        ...
        <div class="container-fluid hidden-print" style="background-image: url({{asset('assets/img/fundo-logo.jpg')}}); margin-bottom: -20px">
            <div class="container">
                <div class="row">
                    <img src="{{asset('assets/img/logo-principal.jpg')}}">
                </div>
            </div>
        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                        	<li><a href="cad_user.pdf" target="_blank">Form. de Cadastro de Usuário</a></li>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li><a href="../resources/views/principal.php"><i class="fa fa-user"></i> PAINEL</a></li>
