            ...
            <nav class="navbar navbar-gov" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <?php
                        $rs_get_menu = DBRead('area', "where site = '$site' and menu <> 'p' and cd_area <> 285 and cd_area <> 329 and cd_area <> 395"); 
					...
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#">Banco de Informações <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="download.php">Downloads</a></li>
							<li><a href="arquivo.php">Notícias antigas</a></li>
							<li><a href="editais.php">Editais e licitações antigos</a></li>
						</ul>
					</li>
