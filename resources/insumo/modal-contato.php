...
if (isset($_POST['enviar'])) {
    ...
    $ecpatcha = '';
        ...
        $mail->Username = 'contato@sead.ap.gov.br'; //email para smtp autenticado
        $mail->Password = 'oUMmze4v5BRI4X4sP45YJA'; //seleciona a porta de envio 
        $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = '587';                                    // TCP port to connect to

        $mail->From = "cotec@prodap.ap.gov.br"; // Seu e-mail
        $mail->Sender = "cotec@prodap.ap.gov.br"; // Seu e-mail
        $mail->FromName = 'Contato via Site PRODAP';
        $mail->addAddress('renanmiranda@hotmail.com.br', 'Renan Miranda');               // Name is optional
        $mail->addAddress('celio@prodap.ap.gov.br', 'Célio Conrado');               // Name is optional
        //$mail->addAddress('celio@prodap.ap.gov.br', 'Célio Conrado');               // Name is optional
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="" class="form-group">
                    ...
                    <div class="form-group col-sm-4 col-md-4">
                        <label>AUTENTICAÇÃO</label><br/>
                        <img src="captcha.php?l=150&a=50&tf=20&ql=5"><br/><br/>
                        <input type="text" class="form-control" id="palavra" name="palavra" required="required">
                    </div>
                    -->
